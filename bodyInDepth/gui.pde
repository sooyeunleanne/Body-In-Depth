...
public void screenshotButton_click(GButton source, GEvent event) { //_CODE_:screenshotButton:480075:
  screenshot();
} //_CODE_:screenshotButton:480075:
...
public void maleButton_click(GButton source, GEvent event) { //_CODE_:maleButton:636687:
  ...
  float activityFactorValue = (activityInput.getValueF())/5 + 1;
...
public void unitConverterButton_click(GButton source, GEvent event) { //_CODE_:unitConverterButton:650238:
  if (!unitConverterOpen) { //if the user opens the unit converter
    unitConverter.setVisible(true);
    unitConverterOpen = true;
    unitConverterButton.setText("Close Unit Converter");
  }
  else {
...
public void createGUI(){
  ...
  dictionaryButton = new GButton(this, 470, 540, 100, 30);
  dictionaryButton.setText("Open Dictionary");
  dictionaryButton.setLocalColorScheme(GCScheme.GREEN_SCHEME);
  dictionaryButton.addEventHandler(this, "dictionaryButton_click");
  screenshotButton = new GButton(this, 525, 25, 50, 50);
  screenshotButton.setIcon("ssIcon.png", 1, GAlign.WEST, GAlign.CENTER, GAlign.MIDDLE);
  screenshotButton.setLocalColorScheme(GCScheme.SCHEME_9);
  screenshotButton.addEventHandler(this, "screenshotButton_click");
  input = GWindow.getWindow(this, "Measurements and Goals", 0, 0, 300, 600, JAVA2D);
  input.noLoop();
  input.setActionOnClose(G4P.KEEP_OPEN);
  input.addDrawHandler(this, "input_draw");
  activityInput = new GSlider(input, 150, 300, 125, 50, 10.0);
  activityInput.setShowValue(true);
  activityInput.setShowLimits(true);
  activityInput.setLimits(0.0, 0.0, 5.0);
  activityInput.setNbrTicks(6);
  ...
  activityLabel2.setText("0 = not active");
  ...
  activityLabel3.setText("5 = very active");
  activityLabel3.setOpaque(false);
  currentLabel = new GLabel(input, 50, 18, 200, 20);
